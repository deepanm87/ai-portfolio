      ...
      >
        ...
        <div>
          ...
          <input 
            ...
            id="email"
            name="email"
            className="w-full py-1.5 @md/form:px-4 @md/form:py-2 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-primary text-sm @md/form:text-base"
            required
            disabled={isPending}
          />
        </div>
        ...
        <div>
          ...
          <input 
            ...
            id="subject"
            name="subject"
            className="w-full px-3 py-1.5 @md/form:x-4 @md/form:py-2 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-primary text-sm @md/form:text-base"
