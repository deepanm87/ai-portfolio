                ...
                {featured.map(achievement => (
                  ...
                  >
                    ...
                    <div className="flex flex-col @xs/card:flex-row @xs/card:items-center gap-2 mb-3">
                      {achievement.type && (
                        <span
                          className={`px-2.5 py-1 text-xs rounded-full font-medium ${getTypeColor(achievement.type)}`}
                        >
                    ...
                    {achievement.url && (
                      ...
                      >
                        Learn More
                        <IconExternalLink className="w-3.5 h-3.5 @md/card:w-4 @md/cardL:h-4" />
                      </Link>
                    )}
                  </div>
                ))}
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-3">
                        {achievement.type && (
                          <span
                            className={`px-2 py-0.5 @md/card:py-1 text-xs rounded-full font-medium ${getTypeColor(achievement.type)}`}
                          >
                            {getTypeLabel(achievement.type)}
                          </span>
                        )}
