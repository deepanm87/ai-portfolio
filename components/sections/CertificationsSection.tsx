          ...
          <div className="grid grid-cols-1 @2xl:grid-cols-2 gap-10">
            {certifications.map(cert => (
              ...
              >
                ...
                >
                  <div
                    className="relative bg-linear-to-br from-zinc-900 via-zinc-900 to-zinc-950 dark:from-zinc-950 dark:via-zinc-950 dark:to-zinc-950 border-2 border-yellow-600/40 p-8 flex flex-col min-h-[450px]"
                  >
                    ...
                    <div className="absolute bottom-0 left-0 w-20 h-20">
                      <div className="absolute bottom-3 left-5 w-10 h-10 border-b-2 border-l-2 border-yellow-600/60" />
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center flex-1">
                      ...
                      <h3 className="text-xs font-bold text-white mb-6 leading-tight px-4">
                        {cert.name}
                      </h3>
                      {cert.description && (
